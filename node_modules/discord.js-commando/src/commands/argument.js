...
class Argument {
	...
	async obtain(msg, value, promptLimit = Infinity) {
		...
		while(!valid || typeof valid === 'string') {
			...
			prompts.push(await msg.reply(msg.channel.send(new Discord.RichEmbed().setColor('RANDOM').setDescription(`${empty ? this.prompt : valid ? valid : `You provided an invalid ${this.label}. Please try again.`}`).setFooter(`İptal Etmek İçin "iptal" Yazın. ${wait ? `Komut ${this.wait} Saniye İçinde Otomatik İptal Edilecektir.` : ''}`))
			));
